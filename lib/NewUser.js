                ...
                <react_native_1.ScrollView style={{ marginTop: 20 }}>
                    <react_native_1.View style={styles.iconText}>
                        ...
                        <react_native_1.View style={{ flex: 0.92 }}>
                            <react_native_1.TextInput placeholder={"Full Name"} placeholderTextColor={"#003EFF"} onChangeText={(fullName) => this.setState({ fullName })} underlineColorAndroid="#003EFF"/>
                        </react_native_1.View>
                    </react_native_1.View>
                    <react_native_1.View style={styles.iconText}>
                        <react_native_1.View style={{ marginTop: 20, flex: 0.08 }}>
                        ...
                        <react_native_1.View style={{ flex: 0.92 }}>
                            <react_native_1.TextInput placeholder={"Email"} placeholderTextColor={"#003EFF"} onChangeText={(email) => this.setState({ email })} underlineColorAndroid="#003EFF"/>
                        </react_native_1.View>
                    </react_native_1.View>
                    <react_native_1.View style={styles.iconText}>
                        <react_native_1.View style={{ marginTop: 20, flex: 0.08 }}>
                        ...
                        <react_native_1.View style={{ flex: 0.92 }}>
                            <react_native_1.TextInput placeholder={"Graduating University"} placeholderTextColor={"#003EFF"} onChangeText={(school) => this.setState({ school })} underlineColorAndroid="#003EFF"/>
                        </react_native_1.View>
                    </react_native_1.View>
                    <react_native_1.View style={styles.iconText}>
                        <react_native_1.View style={{ marginTop: 20, flex: 0.08 }}>
                        ...
                        <react_native_1.View style={{ flex: 0.92 }}>
                            <react_native_1.TextInput placeholder={"Job Title"} placeholderTextColor={"#003EFF"} onChangeText={(jobTitle) => this.setState({ jobTitle })} underlineColorAndroid="#003EFF"/>
                        </react_native_1.View>
                    </react_native_1.View>
                    <react_native_1.View style={styles.iconText}>
                        <react_native_1.View style={{ marginTop: 20, flex: 0.08 }}>
                        ...
                        <react_native_1.View style={{ flex: 0.92 }}>
                            <react_native_1.TextInput placeholder={"About Me"} placeholderTextColor={"#003EFF"} onChangeText={(aboutMe) => this.setState({ aboutMe })} underlineColorAndroid="#003EFF"/>
                        </react_native_1.View>
                    </react_native_1.View>
...
NewUser.navigationOptions = ({ navigation }) => {
    return {
