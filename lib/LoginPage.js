                ...
                <react_native_1.View style={{ flex: 0.65 }}>
                    <Swiper style={styles.wrapper} horizontal={true} autoplay={false}>
                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require("../asset/login_img/group1.jpg")} style={styles.image}>
                            <react_native_1.Text style={styles.text}>Welcome to Crowder</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>

                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require("../asset/login_img/group2.jpg")} style={styles.image}>
                                <react_native_1.Text style={styles.textBottom}>Explore around</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>

                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require("../asset/login_img/group3.jpg")} style={styles.image}>
                                <react_native_1.Text style={styles.text}>Find stuff you're into</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>

                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require("../asset/login_img/group4.jpg")} style={styles.image}>
                                <react_native_1.Text style={styles.text}>Meet a chill crowd</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>
