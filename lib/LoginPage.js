                ...
                <react_native_1.View style={{ flex: 0.65 }}>
                    <Swiper style={styles.wrapper} horizontal={true} autoplay>
                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require('./img/group1.jpg')} style={styles.image}>
                            <react_native_1.Text style={styles.text}>Welcome to Crowder</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>

                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require('./img/group2.jpg')} style={styles.image}>
                                <react_native_1.Text style={styles.text}>Explore around you</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>

                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require('./img/group3.jpg')} style={styles.image}>
                                <react_native_1.Text style={styles.text}>Find stuff you're into</react_native_1.Text>
                            </react_native_1.ImageBackground>
                        </react_native_1.View>

                        <react_native_1.View style={styles.slide}>
                            <react_native_1.ImageBackground source={require('./img/group4.jpg')} style={styles.image}>
